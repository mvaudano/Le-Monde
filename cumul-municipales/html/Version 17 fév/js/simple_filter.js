...
jQuery(document).ready(function($) {
  ...
  $(function () {
    ...
    $('#infos').click(function (e) {
        e.preventDefault();
        $(window).scrollTop($('#methodologie').offset().top);
    });

    $('.scrolltop').click(function (e) {
        e.preventDefault();
        $(window).scrollTop($('#raccourcis').offset().top);
    });
...
function filterInit(donnees) {
  ...
  var view = function(donnee){
    ...
    html = "<div class=\"box_personne\" title=\"Cliquez pour afficher sur la carte\"><div class=\"situation txt12 "+donnee.situation+"\">"+ situation + "</div><p class=\"candidat txt20\"><strong><span class=\"prenom\">"+ donnee.prenom + "</span> <span class=\"nom\">"+donnee.nom +"</span></strong></p><p class=\"parti txt12\">("+ donnee.mandatparl.toLowerCase() + " "+ donnee.parti +")</p></p><p class=\"ville txt15_120\">"
    if(donnee.lien) {
  ...
  var filter_callbacks = {
    after_filter: function(result){
            ...
            $('#partagesocial').html("<p>Partagez cette recherche avec le mot-clé <a href=\"https://twitter.com/search?q=%23alertecumul&src=typd\" target=\"_blank\">#alertecumul</a> :</p><p><iframe allowtransparency=\"true\" frameborder=\"0\" scrolling=\"no\" src=\"https://platform.twitter.com/widgets/tweet_button.html?url="+adresseurl+"&via=lemondefr&hashtags=alertecumul,municipales&lang=fr&count=horizontal\" style=\"width:95px; height:20px; float:left;\"></iframe><iframe src=\"//www.facebook.com/plugins/like.php?href="+adressefb+"&amp;width&amp;layout=standard&amp;action=like&amp;show_faces=true&amp;share=true&amp;height=80&amp;appId=531696896847126\" scrolling=\"no\" frameborder=\"0\" style=\"border:none; overflow:hidden; height:20px; width:280px; float:left;\" allowTransparency=\"true\"></iframe>");

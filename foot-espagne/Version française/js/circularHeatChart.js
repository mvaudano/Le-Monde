            ...
            var svg = d3.select(this);
                   ...
                   /* ir_u = innerRadius + j * segmentHeight;
                    ...
                    g.selectAll("path").data(datum)
                        ...
                        .attr("title", function(d, i) { 
                            ...
                            if(tableau[1]) {
                                html += "<li style=\"border-left-color:"+couleurs[tableau[1]]+"\">Coupe du monde : <strong>"+tableau[1]+"</strong></li>";
                            }
                            else {
                                html += "<p>Aucune compétition jouée cette année-là</p>"
                            }
                            if(tableau[3]) {
                                html += "<li style=\"border-left-color:"+couleurs[tableau[3]]+"\">Euro : <strong>"+tableau[3]+"</strong></li>";
                            }
                            if(d[2] > 1991) { c1 = "Ligue des champions"}
                            else { c1 = "Coupe des clubs champions"}
                            if(tableau[5]) {
                                html += "<li style=\"border-left-color:"+couleurs[tableau[5]]+"\">"+c1+" (C1) : <strong>"+tableau[6]+" ("+tableau[5]+")</strong></li>";
                            }
                            if(d[2] > 2009) { c3 = "Ligue Europa"}
                            else { c3 = "Coupe de l'UEFA"}
                            if(tableau[7]) {
                ...
                .attr({
                    "d":"M232.393,579.371c0.66,5.961,2.422,13.593,5.031,18.702l-8.309-5.588l-9.96,1.021C223.862,590.226,229.007,584.32,232.393,579.371z",
                        "title":"En 1975, l'Allemagne rafle les quatre titres, avec son équipe nationale, le Bayern Munich et le Borussia Mönchengladbach."
                    });
                ...
                .attr({
                    "d":"M144.197,38.007c-5.96,0.67-13.588,2.445-18.694,5.062l5.574-8.319l-1.038-9.958C133.328,29.494,139.242,34.629,144.197,38.007z",
                        "title":"En 2012, l'Espagne conserve les quatre titres pendant 10 jours."
                    });
                indications.append("line")
                .attr({
                    "x1":"112.724",
                ...
                .attr({
                    "d":"M204.883,17.601c4.823-3.565,10.537-8.921,13.646-13.744l-0.659,9.992l5.885,8.1C218.554,19.526,210.864,18.042,204.883,17.601z",
                        "title":"Depuis le 24 mai 2014, et jusqu'à une éventuelle défaite à la Coupe du monde, l'Espagne est tenante des quatre titres."
                    });
                indications.append("line")
                .attr({
                    "x1":"236",

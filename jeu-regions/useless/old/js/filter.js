  ...
  _FilterJS.prototype = {
    ...
    search: function (search_config, filter_result) {
      ...
      if(val == "") { 
        ...
        googleMap.reCentrer(); 
        $("#notule").html("<p class=\"tt5\" align=\"center\">Les points oranges sur la carte représentent les communes dont nous avons déjà archivé le programme. N'hésitez pas à nous aider à compléter la carte en cliquant ci-dessus.</p>");
        $(".revenir").css("display","none")
       }
      else {
        console.log("ya")
